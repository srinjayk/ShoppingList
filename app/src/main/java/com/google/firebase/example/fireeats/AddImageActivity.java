...
//                setPic();
    ...
    private void dispatchTakePictureIntent() {
        ...
        if (takePictureIntent.resolveActivity(getPackageManager()) != null) {
            ...
            if (photoFile != null) {
                System.out.println("Errojhfghjgmn");
                Uri photoURI = FileProvider.getUriForFile(this,
                        "com.google.firebase.example.fireeats.fileprovider",
                        photoFile);
...
//            System.out.println(intent.getStringExtra(MediaStore.EXTRA_OUTPUT));
//            rotateImage(imageView);
                ...
                try {
                                ...
                                myBitmap = MediaStore.Images.Media.getBitmap(getContentResolver(), Uri.fromFile(file));
                                if (myBitmap != null) {
                                    imageView.setImageBitmap(myBitmap);
                                }
                                imageView.setRotation(90);
