...
public class Restaurant {
    ...
    public static final String ADDED_BY = "user";
    ...
    public Restaurant(String name, String city, String category,
...
//        this.photo = photo;
    ...
    public Restaurant(String name, String city, String category,
                      int price, int numRatings, double avgRating, int quantity) {
        this.name = name;
        this.city = city;
        this.category = category;
//        this.photo = photo;
