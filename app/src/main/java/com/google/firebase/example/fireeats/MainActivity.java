...
//    private TextView mTextView;
    ...
    private RestaurantDialogFragment mRestaurantDialog;
...
//        mTextView = (TextView) findViewById(R.id.camera_text_view);
        ...
        findViewById(R.id.add_restaurant_choice).setOnClickListener(this);
        ...
        mRestaurantDialog = new RestaurantDialogFragment();
...
//        }
    ...
    public void onFilter(Filters filters) {
        ...
        Query query = mFirestore.collection("restaurants" + "." + FirebaseAuth.getInstance().getCurrentUser().getEmail());
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.filter_bar:
                onFilterClicked();
                break;
            case R.id.add_restaurant_choice:
                addRestaurantClicked();
                break;
//            case R.id.add_OCR_main:
//                addRestaurantClicked_V_2();
//                break;
...
//        intent.putExtra(RestaurantDetailActivity.KEY_RESTAURANT_ID, restaurant.getId());
    ...
    public void addRestaurantClicked() {
        // Show the dialog containing filter options
        mRestaurantDialog.show(getSupportFragmentManager(), RestaurantDialogFragment.TAG);
    }
    ...
    @Override
    public void addRestaurantClicked_V_2() {
