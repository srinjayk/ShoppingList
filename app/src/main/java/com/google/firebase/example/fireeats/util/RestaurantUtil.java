...
public class RestaurantUtil {
    ...
    private MaterialRatingBar mPriceBar;
    private MaterialRatingBar mRatingBar;
    private EditText mRestaurantName;
    private EditText mRestaurantCategory;
    private EditText mRestaurantPlace;
...
//        Restaurant restaurant = new Restaurant(mNa)
